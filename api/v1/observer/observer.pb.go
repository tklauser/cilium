...
// DropReason from public import flow/flow.proto
type DropReason = flow.DropReason

var DropReason_name = flow.DropReason_name
var DropReason_value = flow.DropReason_value

const DropReason_DROP_REASON_UNKNOWN = DropReason(flow.DropReason_DROP_REASON_UNKNOWN)
const DropReason_INVALID_SOURCE_MAC = DropReason(flow.DropReason_INVALID_SOURCE_MAC)
const DropReason_INVALID_DESTINATION_MAC = DropReason(flow.DropReason_INVALID_DESTINATION_MAC)
const DropReason_INVALID_SOURCE_IP = DropReason(flow.DropReason_INVALID_SOURCE_IP)
const DropReason_POLICY_DENIED = DropReason(flow.DropReason_POLICY_DENIED)
const DropReason_INVALID_PACKET_DROPPED = DropReason(flow.DropReason_INVALID_PACKET_DROPPED)
const DropReason_CT_TRUNCATED_OR_INVALID_HEADER = DropReason(flow.DropReason_CT_TRUNCATED_OR_INVALID_HEADER)
const DropReason_CT_MISSING_TCP_ACK_FLAG = DropReason(flow.DropReason_CT_MISSING_TCP_ACK_FLAG)
const DropReason_CT_UNKNOWN_L4_PROTOCOL = DropReason(flow.DropReason_CT_UNKNOWN_L4_PROTOCOL)
const DropReason_CT_CANNOT_CREATE_ENTRY_FROM_PACKET = DropReason(flow.DropReason_CT_CANNOT_CREATE_ENTRY_FROM_PACKET)
const DropReason_UNSUPPORTED_L3_PROTOCOL = DropReason(flow.DropReason_UNSUPPORTED_L3_PROTOCOL)
const DropReason_MISSED_TAIL_CALL = DropReason(flow.DropReason_MISSED_TAIL_CALL)
const DropReason_ERROR_WRITING_TO_PACKET = DropReason(flow.DropReason_ERROR_WRITING_TO_PACKET)
const DropReason_UNKNOWN_L4_PROTOCOL = DropReason(flow.DropReason_UNKNOWN_L4_PROTOCOL)
const DropReason_UNKNOWN_ICMPV4_CODE = DropReason(flow.DropReason_UNKNOWN_ICMPV4_CODE)
const DropReason_UNKNOWN_ICMPV4_TYPE = DropReason(flow.DropReason_UNKNOWN_ICMPV4_TYPE)
const DropReason_UNKNOWN_ICMPV6_CODE = DropReason(flow.DropReason_UNKNOWN_ICMPV6_CODE)
const DropReason_UNKNOWN_ICMPV6_TYPE = DropReason(flow.DropReason_UNKNOWN_ICMPV6_TYPE)
const DropReason_ERROR_RETRIEVING_TUNNEL_KEY = DropReason(flow.DropReason_ERROR_RETRIEVING_TUNNEL_KEY)
const DropReason_ERROR_RETRIEVING_TUNNEL_OPTIONS = DropReason(flow.DropReason_ERROR_RETRIEVING_TUNNEL_OPTIONS)
const DropReason_INVALID_GENEVE_OPTION = DropReason(flow.DropReason_INVALID_GENEVE_OPTION)
const DropReason_UNKNOWN_L3_TARGET_ADDRESS = DropReason(flow.DropReason_UNKNOWN_L3_TARGET_ADDRESS)
const DropReason_STALE_OR_UNROUTABLE_IP = DropReason(flow.DropReason_STALE_OR_UNROUTABLE_IP)
const DropReason_NO_MATCHING_LOCAL_CONTAINER_FOUND = DropReason(flow.DropReason_NO_MATCHING_LOCAL_CONTAINER_FOUND)
const DropReason_ERROR_WHILE_CORRECTING_L3_CHECKSUM = DropReason(flow.DropReason_ERROR_WHILE_CORRECTING_L3_CHECKSUM)
const DropReason_ERROR_WHILE_CORRECTING_L4_CHECKSUM = DropReason(flow.DropReason_ERROR_WHILE_CORRECTING_L4_CHECKSUM)
const DropReason_CT_MAP_INSERTION_FAILED = DropReason(flow.DropReason_CT_MAP_INSERTION_FAILED)
const DropReason_INVALID_IPV6_EXTENSION_HEADER = DropReason(flow.DropReason_INVALID_IPV6_EXTENSION_HEADER)
const DropReason_IP_FRAGMENTATION_NOT_SUPPORTED = DropReason(flow.DropReason_IP_FRAGMENTATION_NOT_SUPPORTED)
const DropReason_SERVICE_BACKEND_NOT_FOUND = DropReason(flow.DropReason_SERVICE_BACKEND_NOT_FOUND)
const DropReason_NO_TUNNEL_OR_ENCAPSULATION_ENDPOINT = DropReason(flow.DropReason_NO_TUNNEL_OR_ENCAPSULATION_ENDPOINT)
const DropReason_FAILED_TO_INSERT_INTO_PROXYMAP = DropReason(flow.DropReason_FAILED_TO_INSERT_INTO_PROXYMAP)
const DropReason_REACHED_EDT_RATE_LIMITING_DROP_HORIZON = DropReason(flow.DropReason_REACHED_EDT_RATE_LIMITING_DROP_HORIZON)
const DropReason_UNKNOWN_CONNECTION_TRACKING_STATE = DropReason(flow.DropReason_UNKNOWN_CONNECTION_TRACKING_STATE)
const DropReason_LOCAL_HOST_IS_UNREACHABLE = DropReason(flow.DropReason_LOCAL_HOST_IS_UNREACHABLE)
const DropReason_NO_CONFIGURATION_AVAILABLE_TO_PERFORM_POLICY_DECISION = DropReason(flow.DropReason_NO_CONFIGURATION_AVAILABLE_TO_PERFORM_POLICY_DECISION)
const DropReason_UNSUPPORTED_L2_PROTOCOL = DropReason(flow.DropReason_UNSUPPORTED_L2_PROTOCOL)
const DropReason_NO_MAPPING_FOR_NAT_MASQUERADE = DropReason(flow.DropReason_NO_MAPPING_FOR_NAT_MASQUERADE)
const DropReason_UNSUPPORTED_PROTOCOL_FOR_NAT_MASQUERADE = DropReason(flow.DropReason_UNSUPPORTED_PROTOCOL_FOR_NAT_MASQUERADE)
const DropReason_FIB_LOOKUP_FAILED = DropReason(flow.DropReason_FIB_LOOKUP_FAILED)
const DropReason_ENCAPSULATION_TRAFFIC_IS_PROHIBITED = DropReason(flow.DropReason_ENCAPSULATION_TRAFFIC_IS_PROHIBITED)
const DropReason_INVALID_IDENTITY = DropReason(flow.DropReason_INVALID_IDENTITY)
const DropReason_UNKNOWN_SENDER = DropReason(flow.DropReason_UNKNOWN_SENDER)
const DropReason_NAT_NOT_NEEDED = DropReason(flow.DropReason_NAT_NOT_NEEDED)
const DropReason_IS_A_CLUSTERIP = DropReason(flow.DropReason_IS_A_CLUSTERIP)
const DropReason_FIRST_LOGICAL_DATAGRAM_FRAGMENT_NOT_FOUND = DropReason(flow.DropReason_FIRST_LOGICAL_DATAGRAM_FRAGMENT_NOT_FOUND)
const DropReason_FORBIDDEN_ICMPV6_MESSAGE = DropReason(flow.DropReason_FORBIDDEN_ICMPV6_MESSAGE)
const DropReason_DENIED_BY_LB_SRC_RANGE_CHECK = DropReason(flow.DropReason_DENIED_BY_LB_SRC_RANGE_CHECK)
const DropReason_SOCKET_LOOKUP_FAILED = DropReason(flow.DropReason_SOCKET_LOOKUP_FAILED)
const DropReason_SOCKET_ASSIGN_FAILED = DropReason(flow.DropReason_SOCKET_ASSIGN_FAILED)
const DropReason_PROXY_REDIRECTION_NOT_SUPPORTED_FOR_PROTOCOL = DropReason(flow.DropReason_PROXY_REDIRECTION_NOT_SUPPORTED_FOR_PROTOCOL)
