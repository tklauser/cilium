...
![Version: 1.9.0-cee.1](https://img.shields.io/badge/Version-1.9.0--cee.1-informational?style=flat-square) ![AppVersion: 1.9.0-cee.1](https://img.shields.io/badge/AppVersion-1.9.0--cee.1-informational?style=flat-square)
...
| clustermesh.apiserver.image.tag | string | `"v1.9.0-cee.1"` |  |
...
| hubble.relay.image.tag | string | `"v1.9.0-cee.1"` |  |
...
| operator.image.tag | string | `"v1.9.0-cee.1"` |  |
...
| preflight.image.tag | string | `"v1.9.0-cee.1"` |  |
